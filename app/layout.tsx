...
export const metadata: Metadata = {
  ...
  description:
    'Seth Mbaka. A fullstack react, nodejs and nextjs developer.',
  openGraph: {
    title: 'GrimFunky',
    description:
      'Seth Mbaka. A fullstack react and nextjs developer.',
    ...
    images: [
      {
        ...
        width: 1920,
        height: 1080,
        alt: `Seth's website's homepage showing the title, a short description, social links and a grid of pictures`,
      },
    ],
    locale: 'en-US',
    type: 'website',
  ...
  twitter: {
    ...
    images: [
      {
        url: '',
        alt: `Seth mbaka's homepage showing the title, a short description, social links and a grid of pictures`,
      },
    ],
  },
};
